@extends('layout.app')
@section('style')
    <link href="{{ asset('assets/css/light-list-group.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/light-user-profile.css') }}" rel="stylesheet" type="text/css" />

    <link href="{{ asset('assets/css/dark-list-group.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/dark-user-profile.css') }}" rel="stylesheet" type="text/css" />
@endsection
                        ...
                        <div class="user-profile">
                            <div class="widget-content widget-content-area">
                                <div class="d-flex justify-content-between">
                                    <h3 class="">Profile</h3>
                                    <a href="./user-account-settings.html" class="mt-2 edit-profile"> <svg
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="progress br-30">
                                                        <div class="progress-bar br-30 bg-warning" role="progressbar"
                                                            style="width: 39%" aria-valuenow="25" aria-valuemin="0"
                                                            aria-valuemax="100"></div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress br-30">
                                                        <div class="progress-bar br-30 bg-success" role="progressbar"
                                                            style="width: 78.03%" aria-valuenow="25" aria-valuemin="0"
                                                            aria-valuemax="100"></div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress br-30">
                                                        <div class="progress-bar br-30 bg-danger" role="progressbar"
                                                            style="width: 19.15%" aria-valuenow="25" aria-valuemin="0"
                                                            aria-valuemax="100"></div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress br-30">
                                                        <div class="progress-bar br-30 bg-info" role="progressbar"
                                                            style="width: 60.55%" aria-valuenow="25" aria-valuemin="0"
                                                            aria-valuemax="100"></div>
                                                    </div>
                                                </td>
                                                <td>
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
                        <div class="payment-methods layout-spacing ">
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="list-group">
                                    <div class="list-group-item d-flex justify-content-between align-items-start">
                                        <img src="{{ asset('assets/img/card-americanexpress.svg') }}"
                                    ...
                                    <div class="list-group-item d-flex justify-content-between align-items-start">
                                        <img src="{{ asset('assets/img/card-mastercard.svg') }}"
                                    ...
                                    <div class="list-group-item d-flex justify-content-between align-items-start">
                                        <img src="{{ asset('assets/img/card-visa.svg') }}" class="align-self-center me-3"
                                            alt="visa">
                                        <div class="me-auto">
