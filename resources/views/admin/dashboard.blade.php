...
@section('style')
    ...
    <link href="{{asset('assets/css/light-dash_1.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('assets/css/dark-dash_1.css')}}" rel="stylesheet" type="text/css" />
                            ...
                            <div class="widget widget-card-four">
                                <div class="widget-content">
                                    ...
                                    <div class="w-content">
                                        ...
                                        <div class="w-info">
                                            <p class="value">0 <span>this week</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trending-up"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg></p>
                                        </div>
                                ...
                                <div class="widget-content">
                                    <div class="account-box">
                                        ...
                                        <div class="info-box">
                                            <div class="icon">
                                                <span>
                                                    <img src="{{asset('assets/img/money-bag.png')}}" alt="money-bag">
                                                </span>
                                            </div>
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="progress-data">
                                        ...
                                        <div class="progress-info">
                                            ...
                                            <div class="progress-stats"><p>0%</p></div>
                                        </div>
                                    ...
                                    <div class="meta-info">
                                        ...
                                        <div class="avatar--group">
                                            ...
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="{{asset('assets/img/profile-8.jpeg')}}"/>
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="{{asset('assets/img/profile-12.jpeg')}}"/>
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="{{asset('assets/img/profile-19.jpeg')}}"/>
                                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-card-one">
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        <div class="w-img">
                                            <img src="{{asset('assets/img/profile-19.jpeg')}}" alt="avatar">
                                        </div>
                            ...
                            <div class="widget widget-card-two">
                                <div class="widget-content">
                                    ...
                                    <div class="card-bottom-section">
                                        ...
                                        <div class="img-group">
                                            <img src="{{asset('assets/img/profile-19.jpeg')}}" alt="avatar">
                                            <img src="{{asset('assets/img/profile-6.jpeg')}}" alt="avatar">
                                            <img src="{{asset('assets/img/profile-8.jpeg')}}" alt="avatar">
