                    ...
                    <div class="row">
                        ...
                        <div id="flLoginForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <form action="{{ route('user.update', $user->id) }}"  method="POST" class="row g-3" style="margin-left:2rem; margin-right:2rem;">
                                      @csrf  
                                      @method('PATCH')

                                        <div class="col-md-6">
                                            <label for="inputName" class="form-label">Name</label>
                                            <input type="text" class="form-control add-billing-address-input" value="{{ $user->name }}" name="name" value="{{old('name')}}" required  placeholder="Enter Your Name *" style ="">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" class="form-control" name="email" value="{{ $user->email }}" required  placeholder="Enter Your Email ID *" style ="">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="country" id="country" value="{{ $user->country }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="mobile" value="{{ $user->mobile }}" required  placeholder="Enter Your Mobile No. *" style ="">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="password" class="form-control" name="password" value="{{ $user->password }}" placeholder="Enter 8 Digit Password *" value="{{old('password')}}" required minlength="8" style ="">
                                            <div class="invalid-feedback">
