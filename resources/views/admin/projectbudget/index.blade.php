...
@section('style')
    ...
    <link href="{{asset('assets/css/dark-scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="{{('assets/css/dark-custom-jquery.bootstrap-touchspin.min.css')}}">
    <!-- End CSS Section -->
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                @csrf
                                    <div class="row g-3">
                                        ...
                                        <input type="number" id="inputproject" name="budget" value="{{ old('budget', $project->budget ?? '') }}" class="form-control" min="0" max="10000000" step="1"  style="height:45px;width:300px;padding-left:25px;">
                                        </div>

                                        <div class="col-sm-4">
                                        <label> Min hourly budget (in USD)</label>
                                        <input type="number" id="inputproject" name="time" value="{{ old('time', $project->time ?? '') }}" class="form-control" min="0" max="10000" step="1"  style="height:45px; width:300px; padding-left:25px; border: 1px solid #bfc9d4; color: #3b3f5c; background-color: #fff; border-radius: 6px;">
                                        </div>
