...
<!-- Mirrored from designreset.com/cork/html/modern-light-menu/auth-cover-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jun 2024 11:17:57 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <title>SignUp Cover | BID MANAGER </title>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form action=" {{ route('pages.dosignup') }} " method="post" class="row g-3 needs-validation" novalidate>
                                    @csrf
                                ...
                                <div class="col-sm-4 col-12">
                                    <div class="mb-4">
                                        <button class="btn btn-social-login w-100">
                                            <img src="https://designreset.com/cork/html/src/assets/img/github-icon.svg"
                                                alt="" class="img-fluid">
                                ...
                                <div class="col-sm-4 col-12">
                                    <div class="mb-4">
                                        <button class="btn btn-social-login w-100">
                                            <img src="https://designreset.com/cork/html/src/assets/img/twitter.svg"
                                                alt="" class="img-fluid">
                                ...
                                <div class="col-12">
                                    <div class="text-center">
                                        <p class="mb-0">Already have an account ? <a href="{{ route('auth.login') }}"
